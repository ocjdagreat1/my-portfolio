...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/ocjdagreat1/my-portfolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/ocjdagreat1/my-portfolio/pulls).
...
git clonehttps://github.com/ocjdagreat1/my-portfolio
...
- Navigate to `package.json` and enter your domain name instead of `https://ocjdagreat1.github.io/my-portfolio/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/my-portfolio`, add the same to the homepage section of `package.json`.
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/ocjdagreat1/my-portfolio/pulls).
